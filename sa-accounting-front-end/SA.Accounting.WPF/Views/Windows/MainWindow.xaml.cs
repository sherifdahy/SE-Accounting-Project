...
public partial class MainWindow : Window
{
    ...
    private async Task ApplyPermissionsAsync()
    {
        ...
        // الموظفين
        bool canViewUsers = await _permissionService.HasPermissionAsync("users:read");
        UsersBtn.Visibility = canViewUsers ? Visibility.Visible : Visibility.Collapsed;
    ...
    {
        SetActiveButton((Button)sender);
        PageTitleHeader.Text = "إدارة المستخدمين";

        var usersControl = _serviceProvider.GetRequiredService<UsersControl>();
        MainSection.Content = usersControl;
    }
