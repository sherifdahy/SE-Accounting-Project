    ...
    public partial class update_some_entities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyUserTransactions", x => new { x.CompanyId, x.UserId, x.TransactionId });
                    table.ForeignKey(
                        name: "FK_CompanyUserTransactions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompanyUserTransactions_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompanyUserTransactions_Transactions_TransactionId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "727F7C04-0A04-4012-9AA0-5BDF83C53788", false, "Admin", "ADMIN" },
                    { 3, "D5CD1328-D599-4608-B5B0-C00056B6E7D7", false, "Employee", "EMPLOYEE" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyUserTransactions_TransactionId",
                table: "CompanyUserTransactions",
                column: "TransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyUserTransactions_UserId",
                table: "CompanyUserTransactions",
                column: "UserId");
