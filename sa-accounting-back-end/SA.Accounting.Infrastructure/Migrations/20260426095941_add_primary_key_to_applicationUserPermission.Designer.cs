...
namespace SA.Accounting.Infrastructure.Migrations
{
    ...
    [Migration("20260426095941_add_primary_key_to_applicationUserPermission")]
    partial class add_primary_key_to_applicationUserPermission
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SA.Accounting.Core.Entities.Identity.ApplicationUserPermission", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SA.Accounting.Core.Entities.Identity.ApplicationUserPermission", b =>
                {
                    b.HasOne("SA.Accounting.Core.Entities.Identity.ApplicationUser", "ApplicationUser")
