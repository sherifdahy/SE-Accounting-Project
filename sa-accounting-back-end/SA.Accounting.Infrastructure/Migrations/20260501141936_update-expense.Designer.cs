...
namespace SA.Accounting.Infrastructure.Migrations
{
    ...
    [Migration("20260501141936_update-expense")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SA.Accounting.Core.Entities.Transactions.ExpenseCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SA.Accounting.Core.Entities.Transactions.ExpenseClaimItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SA.Accounting.Core.Entities.Transactions.ExpenseClaimItem", b =>
                {
                    ...
                    b.HasOne("SA.Accounting.Core.Entities.Transactions.ExpenseCategory", "ExpenseCategory")
                        .WithMany("ExpenseClaimItems")
